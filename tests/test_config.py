...
def test_load_config_file_exists(mock_ensure_dir, mock_config_file):
...
def test_load_config_file_not_exists(mock_datetime, mock_ensure_dir, mock_config_file):
...
@patch("ynab_sync.config.CONFIG_FILE")
@patch("ynab_sync.config.ensure_config_dir")
def test_save_config(mock_ensure_dir, mock_config_file):
...
@patch("ynab_sync.config.datetime")
def test_update_last_sync(mock_datetime, mock_save_config, mock_load_config):
